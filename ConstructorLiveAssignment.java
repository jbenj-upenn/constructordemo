...
public class ConstructorLiveAssignment {
    ...
    public static void main(String[] args) {
        ...
        mandatoryOptional manOpt = // complete your object; feel free to change its name!


    }
}
    //Second file/class: mandatoryOptional
    //Not that the files are separated in the Project structure on the left
